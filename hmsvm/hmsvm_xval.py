...
try:
	dummy = PrimalMosekSOSMV()
except ImportError:
	print 'PrimalMosekSOSVM import failed, compile Shogun with Mosek support'
	import sys
	sys.exit(0)
...
'''
Presumably buggy way using TwoStateModel.simulate_data

for _ in xrange(K):
	models.append(TwoStateModel.simulate_data(num_fold_examples, example_len, num_features,
		num_noise_features))
'''
